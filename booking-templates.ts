...
import { getSiteDisplayHost, getSiteUrl } from "@/lib/env";
...
function emailShell(params: {
  ...
  const siteHost = getSiteDisplayHost();
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr><td style="border-top:1px solid ${BRAND.border};padding-top:20px;">
                  ...
                  <p style="margin:12px 0 0;font-size:12px;color:${BRAND.muted};">
                    <a href="${siteUrl}" style="color:${BRAND.muted};text-decoration:underline;">${escapeHtml(siteHost)}</a>
